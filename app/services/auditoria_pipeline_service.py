...
COLUNAS_AUDITORIA_FLAT: List[str] = [
    ...
    "volume_total_candidato", "km_referencia_candidato", "km_total_estimado_candidato", "ocupacao_perc_candidato",
    "corredores_considerados", "corredor_ancora", "diff_corredor_max",
    "qtd_itens_bloco", "peso_total_bloco", "volume_total_bloco", "km_referencia_bloco", "corredor_dominante_bloco",
    "corredor_min_idx", "corredor_max_idx", "eixo_dominante_bloco", "qtd_corredores_bloco",
    "km_total_estimado_m5_4", "corredor_ancora_m5_4", "diff_corredor_max_m5_4", "motivo_final_remanescente_m5_4",
    ...
    "corredor_item_candidato_m6_2", "corredor_manifesto_ancora_m6_2", "diff_corredor_m6_2",
    "km_total_estimado_manifesto_pos_encaixe", "fonte_km_estimado_m6_2", "motivo_detalhado_m6_2",
    "km_total_estimado_m6_2", "corredor_ancora_m6_2", "diff_corredor_max_m6_2",
